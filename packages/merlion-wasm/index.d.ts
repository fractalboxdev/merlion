// Types for the hand-written glue (specs/integrations.md#fractalboxmerlion-wasm).
// This file is the JavaScript contract of Merlion: @fractalbox/merlion-rehype, the
