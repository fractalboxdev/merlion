...
| Legibility | Share of labels whose laid-out ink leaves the shape they sit in; pairs of node shapes overlapping; ink outside the `viewBox` | Measured in Chromium, because text advance depends on the font the browser resolves and nothing in the SVG source records it |
